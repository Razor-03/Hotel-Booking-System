...
const BookingsCard = ({ bookings }) => (
  <div className="bg-white shadow-md rounded-lg p-4">
    ...
    <p className="text-gray-700">Total Bookings: {bookings.pendingBookings}</p>
    <p className="text-gray-700">Total Bookings: {bookings.rejectedBookings}</p>
    <p className="text-gray-700">Total Bookings: {bookings.approvedBookings}</p>
  </div>
);
...
const RoomsCard = ({ rooms }) => (
  <div className="bg-white shadow-md rounded-lg p-4">
    ...
    <p className="text-gray-700">Total Rooms: {rooms.availableRooms}</p>
    <p className="text-gray-700">Total Rooms: {rooms.bookedRooms}</p>
  </div>
);
